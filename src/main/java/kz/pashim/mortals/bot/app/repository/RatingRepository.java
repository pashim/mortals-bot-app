...
public interface RatingRepository extends CrudRepository<RatingEntity, Long> {
    ...
    Page<RatingEntity> findByChannelAndGroupAndDisciplineOrderByMmrDesc(ChannelEntity channel, GroupEntity group, DisciplineEntity discipline, Pageable pageable);
}
